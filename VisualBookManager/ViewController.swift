...
//  VisualBookManager
//
//  Created by JSMAC on 2020/07/01.
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var genreTextFeild: UITextField!
    @IBOutlet weak var countLabel: UILabel!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        let book1 = Book(name: "햄릿", genre: "희극", author: "세익스피어")
...
//        print("showAllBookAction")
    ...
    @IBAction func registerAction(_ sender: Any) {
        ...
        bookTemp.genre = genreTextFeild.text
    ...
    @IBAction func searchAction(_ sender: Any) {
        ...
        if resultBook != nil {
            ...
            outputTextView.text = "We don't have that you search"
        }
    }
